 ...
 */
public class OkHttpUpload extends OkHttpPost {

    private Pair<String, File>[] files;

    public OkHttpUpload(String url, Map<String, String> params, Pair<String, File>[] files) {
        super(url, params);
        this.files = files;
    }

    public OkHttpUpload(String url, Map<String, String> params, Map<String, String> headers, String tag, Pair<String, File>[] files) {
