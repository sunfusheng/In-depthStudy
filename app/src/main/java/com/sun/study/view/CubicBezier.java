...
public class CubicBezier extends View {
    ...
    private PointEntity mControlPoint1;
    private PointEntity mControlPoint2;
    ...
    private void init(Context context) {
        ...
        mControlPoint1 = new PointEntity(GlobalParams.SCREEN_WIDTH / 2, GlobalParams.SCREEN_HEIGHT / 4);
        mControlPoint2 = new PointEntity(GlobalParams.SCREEN_WIDTH / 2, GlobalParams.SCREEN_HEIGHT * 3 / 4);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(mControlPoint1.x, mControlPoint1.y, 8, mPaintPoint);
        canvas.drawCircle(mControlPoint2.x, mControlPoint2.y, 8, mPaintPoint);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                touchFlag = isTouchPointedRegion(mControlPoint1, event.getX(), event.getY());
                break;
